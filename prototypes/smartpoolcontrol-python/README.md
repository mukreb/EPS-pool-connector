# SmartPoolControl Python prototype (legacy)

> Historical prototype for the platform used before the supplier migrated the
> pool to SmartPoolConnect around April 2026. This old platform is no longer the
> active control path for this installation.
